...
# Synonym mapping for common terms (same as provided)
SYMPTOM_SYNONYMS = {
...
def predict_disease(symptoms, model, tokenizer, max_len, label_encoder, known_symptoms, single_word_symptoms):
    """
    ...
    # Map the class index to the disease name using the label encoder
    ...
    while True:
        ...
        try:
            predicted_disease, confidence = predict_disease(
                symptoms, model, tokenizer, max_len, label_encoder, known_symptoms, single_word_symptoms
            )
